    ...
    <div
        ...
        <div
            ...
            <div class="p-8 text-center">
                ...
                <div class="space-y-3">
                    <NuxtLink to="/"
                        class="block w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-6 rounded-xl transition-colors duration-200">
                        🏠 Go Home
                    </NuxtLink>
                    <button @click="handleError"
                        class="w-full bg-purple-500 hover:bg-purple-600 text-white font-semibold py-3 px-6 rounded-xl transition-colors duration-200">
                        🔄 Try Again
                    </button>
                </div>
            </div>
