                ...
                <div class="bg-white p-4 rounded-lg shadow mt-3">
                    ...
                    <article class="pt-6 pr-3 pb-6 pl-3 border-b border-[#e7e7e7]">
                        ...
                        <div class="mt-1">
                            ...
                            <p class="mt-2 mb-2 leading-[1.2] text-700 text-[#6b6d76] text-sm">
                                ...
                                nutritious, just that it tasted good. Once I tried them, I started reading up on them. I
                                was
                    ...
                    <article class="pt-6 pr-3 pb-6 pl-3 border-b border-[#e7e7e7]">
                        ...
                        <div class="mt-1">
                            ...
                            <p class="mt-2 mb-2 leading-[1.2] text-700 text-[#6b6d76] text-sm">
                                We're a very active family. Hubs is into boats, my son football, daughter volleyball,
                                and
                                I'm a runner. So a snack that's nutritious AND convenient is a must. YOMZ is perfect.
                                Highly
                                recommend!
                            </p>
