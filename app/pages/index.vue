                    ...
                    <div v-for="product in cartData" :key="product.id" class=" w-full pt-6 space-y-6">
                        ...
                        <div name="product-details">
                            ...
                            <div class="bg-gray-100 px-4 py-3 rounded-lg flex justify-between items-center mb-2">
                                <div>
                                    <p class="font-semibold text-gray-700">Total:
                                        <span class="text-sm font-semibold">Before Taxes</span>
                                    </p>
                                </div>
                                ...
                                <div class="flex gap-3 items-baseline">
                                    ...
                                    <!-- total price -->
                                    <span
                                        class="text-md font-semibold text-white line-through bg-[#c91f3f] px-2 py-1 rounded-2xl">
                                        ${{ product.id === 3
